...
public class FireStoneItem extends PleyacraftItem {

    public FireStoneItem(Properties p_41383_) {
        super(p_41383_, "Al lanzar esta piedra quemará alrededor de donde donde golpee, siempre y cuando sean bloques incendiables. Puede usarse para hacer munición para pistola de fuego.");
