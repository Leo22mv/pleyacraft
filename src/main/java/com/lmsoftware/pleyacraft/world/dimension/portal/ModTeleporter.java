package com.lmsoftware.pleyacraft.world.dimension.portal;
...
public class ModTeleporter implements ITeleporter {
    ...
    public Entity placeEntity(Entity entity, ServerLevel currentWorld, ServerLevel destinationWorld,
        ...
        // if (insideDimension) {
        //     boolean shouldSpawnEntity = true;
        //     int radius = 15;
        //     int yOffset = 15;

        //     // Crear un AABB para la región de búsqueda
        //     AABB searchAABB = new AABB(
        //         destinationPos.offset(-radius, -yOffset, -radius),
        //         destinationPos.offset(radius, yOffset, radius)
        //     );

        //     // Crear un VoxelShape a partir del AABB
        //     VoxelShape searchVoxelShape = Shapes.create(searchAABB);

        //     // Obtener todas las entidades en el mundo
        //     List<Entity> allEntities = destinationWorld.getEntities(RocketEntity.class, searchAABB);

        //     // Filtrar las entidades que se superponen con el VoxelShape
        //     List<Entity> overlappingEntities = allEntities.stream()
        //         .filter(entity -> entity.getBoundingBox()
        //             .intersects(searchVoxelShape.getBoundingBox()))
        //         .collect(Collectors.toList());

        //     for (Entity entity : overlappingEntities) {
        //         if (entity instanceof YourEntityType) { // Reemplaza YourEntityType con el tipo de entidad que estás buscando
        ...
        //         // Realiza la acción necesaria para crear una nueva entidad si no se encuentra ninguna
        //     }
        // }
        ...
        //         destinationPos.offset(-10, -10, -10),
        //         destinationPos.offset(10, 10, 10)
        //     );
        
        //     List<Entity> entities = destinationWorld.getEntitiesOfClass(Entity.class, searchArea);
        ...
        //     if (shouldSpawnEntity) {
        //         // Aquí puedes realizar la acción para crear una nueva entidad si no se encuentra ninguna
        //     }
        // }
    ...
    //     boolean destinationIsUG = level.dimension() == ModDimensions.ATLASDIM_KEY;
    //     if (entity.level.dimension() != ModDimensions.ATLASDIM_KEY && !destinationIsUG) {
    //         return null;
    //     }
    //     else {
