...
public class MobsAttrsEvent {
    ...
    public static void entityAttributes(EntityAttributeCreationEvent event) {
        ...
        event.put(InitMobs.UPPER_RIGELIAN.get(), UpperRigelianEntity.getUpperRigelianEntityAttrs().build());
        event.put(InitMobs.ROCKET.get(), RocketEntity.getRocketEntityAttrs().build());
    }
}
